          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <Link href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <div className="w-10 h-10 border border-white/30 rounded-full flex items-center justify-center hover:bg-white/10 transition-colors">
                  <FaFacebookF />
                </div>
              </Link>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="flex">
              <input
                ...
                required
                className="bg-[#002340] border-none outline-none px-4 py-3 rounded-l-md w-full text-white placeholder:text-gray-400"
              />
              <motion.button
                type="submit"
